...
export const metadata: Metadata = {
  ...
  description:
    "Complete dairy management software for milk collection centers, cooperative societies, and dairy unions. AMCS, Sankalan mobile app, FAT/SNF integration. Trusted by 500+ dairies across India.",
  keywords: [
