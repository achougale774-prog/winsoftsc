                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
                        {[
                            ...
                            { icon: Users, title: language === 'mr' ? '२०००+ समाधानी ग्राहक' : language === 'kn' ? '2000+ ಸಂತೋಷದ ಗ್ರಾಹಕರು' : '2000+ Happy Clients', desc: language === 'mr' ? 'संपूर्ण महाराष्ट्रात विश्वासाचे प्रतीक' : language === 'kn' ? 'ಕರ್ನಾಟಕದಾದ್ಯಂತ ನಂಬಿಕೆಯ ಸಂಕೇತ' : 'Trusted by businesses across the state.', color: 'text-purple-500', bg: 'bg-purple-50 dark:bg-purple-500/10' },
                        ].map((stat, i) => (
