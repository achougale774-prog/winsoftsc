...
export function ExitIntentPopup() {
  ...
  const content = {
    mr: {
      ...
      title: "जाण्यापूर्वी Free Demo बुक करा",
      subtitle: "फक्त नाव आणि नंबर द्या — आमची टीम तुम्हाला call करेल आणि software बद्दल सगळी माहिती देईल.",
      namePh: "तुमचे नाव",
      phonePh: "मोबाईल नंबर",
      btn: "Free Call Back मागवा",
      skip: "नको, मी जातो",
      offer: "🎁 आजच book केल्यास — Free on-site demo मिळेल",
    },
    hi: {
      badge: "रुकिए एक मिनट!",
      title: "जाने से पहले Free Demo बुक करें",
      subtitle: "बस नाम और नंबर दें — हमारी टीम आपको call करेगी।",
      namePh: "आपका नाम",
      phonePh: "मोबाइल नंबर",
      btn: "Free Call Back मांगें",
      skip: "नहीं, जाना है",
      offer: "🎁 आज book करें — Free on-site demo पाएं",
    },
    en: {
      badge: "Wait — Before You Go!",
      title: "Get a Free Demo Before You Leave",
      subtitle: "Just your name and number — our team will call you back with a complete walkthrough.",
      namePh: "Your name",
      phonePh: "Mobile number",
      btn: "Request Free Call Back",
      skip: "No thanks",
      offer: "🎁 Book today — Get a free on-site demo",
    },
  }
